    ...
    public partial class reg_print : Form
    {
        ...
        public reg_print(string rno, string nm, string br, string sem, string sc1, string s1, string sc2, string s2, string sc3, string s3, string sc4, string s4, string sc5, string s5, string sc6, string s6, string sc7, string s7, string sc8, string s8, string sc9, string s9, string sc10, string s10, string tot, string sc11, string s11,string roll,string recipt_no)
        {
            ...
            try
            {
                ...
                label41.Text = recipt_no;
                label43.Text = "" + recipt_no;
                if (tot == "1500")
                {
                    label39.Text = "";
                    label40.Text = "";
                    label38.Text = "One Thousand Five Hundred Only";
                    label2.Text = "Cash :1500/-(in Rupees)Fifteen Hundred Rupees";
                }
                else if (tot == "2000")
                {
                    label39.Text = "Fine";
                    ...
                    label2.Text = "Cash :2000/-(in Rupees)Two Thousand Rupees";
                }
                else if (tot == "2500")
                {
                    label39.Text = "Fine";
                    ...
                    label2.Text = "Cash :2500/-(in Rupees)Two Thousand five hundred Rupees";
                }
                if (br == "MBA")
                {
                    label3.Text = "MBA";
        ...
        private void reg_print_FormClosed(object sender, FormClosedEventArgs e)
        {
         }
    }
}
